...
import blacklistDomains from '../routes/v1/blacklist/domain';
import whitelist from '../routes/v1/whitelist';
import reportedlist from '../routes/v1/reportedlist';
import domainslist from '../routes/v1/domainslist';
...
router.get('/v1/blacklist/domains.txt', blacklistDomains);
...
router.get('/v1/domainslist', domainslist);
